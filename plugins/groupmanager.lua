...
if not lang then
   return '_💀 Im G O D  of war and ready my owner gladiator Erfan💀_'
else
return '⚔️ آماده پشتیبانی از مردم این قلمرو هستم  گلادیاتور عرفان⚔️'
  ...
  save_data(_config.moderation.data, data)
      ...
      save_data(_config.moderation.data, data)
    if not lang then
  return '*ready my owner gladiator Erfan*'..msg_caption
else
  return '⚔️ آماده پشتیبانی از مردم این قلمرو شدم  گلادیاتور عرفان⚔️'..msg_caption
end
end
...
text = [[
_دستورات ربات های king & queen:_
